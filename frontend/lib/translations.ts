export const TRANSLATIONS = {
  KZ: {
    ...
    tabMaas: "⚡ MaaS     welcomeBannerSub: "Манускрипттеріңізді WIPO Prior Art Shield арқылы бекітіп, 70/20/10 роялти алу үшін ORCID және Web3 әмияныңызды қосыңыз.",
  ...
  EN: {
    ...
    genFiatInvoiceBtn: "📄 Generate B2B Institutional Invoice (IBAN/Swift)",Assistant",
    tabNotary: "🛡️ Notary",
    tabInspector: "🔍 3-Layer Inspector",
    tabLibrary: "🏛️ Library",
    tabZk: "🔒 ZK-Discovery",
